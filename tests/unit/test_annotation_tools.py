...
@pytest.mark.parametrize(
    ...
    [
        ...
        [typing.List[typing.Tuple], None, exceptions.UnsupportedCast],
        [typing.Union[str, int, None], None, exceptions.UnsupportedCast],
        [typing.Union[str, int], None, exceptions.UnsupportedCast],
        [typing.Union[typing.List, None], None, exceptions.UnsupportedCast],
        [typing.Callable, None, exceptions.UnsupportedCast],
    ],
    ids=[
        "optional_str",
        "union_str_none",
...
def test_get_custom_type_classes(value, expected_type_classes, expected_exception):
    ...
    if expected_exception:
        ...
        assert (
            tuple(
                repr(type_class)
                for type_class in annotation_tools.get_custom_type_classes(
                    value
                )
            )
